...
TMT-Integrator extracts and combines channel abundances from multiple isobaric labeling samples. It takes PSM tables as input, and generates quantification reports at the user-specified levels. TMT-Integrator currently provides four quantification options: gene, protein, peptide, and modified site levels. TMT-Integrator is included in [FragPipe](https://fragpipe.nesvilab.org/) with the Quant (Isobaric) options for complete analyses of isobaric labeling experiments.

There are seven steps in TMT-Integrator, (1) filtering, (2) normalization I, (3) grouping, (4) outlier removal, (5) PSM aggregation, (6) normalization II, (7) intensity conversion.

<div align="center">
<img src="https://raw.githubusercontent.com/Nesvilab/FragPipe/gh-pages/images/TMT-I_overview_transparent.png"/>
</div>
